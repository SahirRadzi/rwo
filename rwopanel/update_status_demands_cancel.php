...
if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
   ...
   $select_listings = $conn->prepare("SELECT * FROM `demand_list` WHERE status = 'Batal' AND unique_id LIKE '%{$search_box}%' AND nokp LIKE '%{$search_box}%'");
   $select_listings->execute();
}else

$select_listings = $conn->prepare("SELECT * FROM `demand_list` WHERE status = 'Batal'");
$select_listings->execute();
