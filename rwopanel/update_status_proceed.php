...
if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
   ...
   $select_listings = $conn->prepare("SELECT * FROM `orders_list` WHERE status = 'Proses' AND unique_id LIKE '%{$search_box}%' AND nokp LIKE '%{$search_box}%'");
   $select_listings->execute();
}else

$select_listings = $conn->prepare("SELECT * FROM `orders_list` WHERE status = 'Proses'");
$select_listings->execute();
