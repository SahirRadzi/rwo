...
if(isset($_POST['update_list'])){
  ...
  $pakej = $_POST['pakej'];
  $pakej = filter_var($pakej, FILTER_SANITIZE_STRING);
  ...
  if(!empty($imgKpB)){
    ...
    $update_listing = $conn->prepare("UPDATE `orders_list` SET email = ?, nama = ?, phoneno = ?, phonenoTambahan = ?, nokp = ?, alamatPemasangan = ?, alamatBill = ?, pakej = ?, tarikhWaktu = ?, catatan = ? WHERE id = ? ");
    $update_listing->execute([$email, $nama, $phoneno, $phonenoTambahan, $nokp, $alamatPemasangan, $alamatBill, $pakej, $tarikhWaktu, $catatan, $update_id]);
...
<div class="signature-box">
  ...
  <div class="gender-box">
    ...
    <div class="gender">
      <input type="radio" id="U89" name="pakej" value="U89" <?php if($fetch_updates['pakej'] == 'U89'){echo 'checked';};?> />
      <label for="U89">Pakej 100Mbps RM 89 Bulanan</label>
    </div>
    <br />
    <div class="gender">
      <input type="radio" id="U139" name="pakej" value="139" <?php if($fetch_updates['pakej'] == 'U139'){echo 'checked';};?> />
      <label for="U139">Pakej 300Mbps RM 139 Bulanan</label>
    </div>
    <br />
    <div class="gender">
      <input type="radio" id="U159" name="pakej" value="U159" <?php if($fetch_updates['pakej'] == 'U159'){echo 'checked';};?> />
      <label for="U159">Pakej 500Mbps RM 159 Bulanan</label>
    </div>
    <br />
    <div class="gender">
      <input type="radio" id="U289" name="pakej" value="U289" <?php if($fetch_updates['pakej'] == 'U289'){echo 'checked';};?> />
  ...
  <div class="input-box">
    ...
    <input type="text" class="box" placeholder="Pilih Tarikh & Waktu" name="tarikhWaktu" id="timedatePicker" required/>
  </div>
