...
if(isset($_POST['submit'])){
  ...
  $imageKpB_folder = '../uploaded_kpb/'.$rename_imgKpB;
    ...
    $insert_addList = $conn->prepare("INSERT INTO `orders_list` (unique_id, email, nama, phoneno, phonenoTambahan, nokp, alamatPemasangan, alamatBill, pakej, tarikhWaktu, imgBill, imgKpD, imgKpB) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)");
    $insert_addList->execute([$unique_id, $email, $nama, $phoneno, $phonenoTambahan, $nokp, $alamatPemasangan, $alamatBill, $pakej, $tarikhWaktu, $rename_imgBill, $rename_imgKpD, $rename_imgKpB]);
...
<head>
    ...
    <title>Add List | RWO Panel</title>
...
<h1 class="heading">add new list</h1>
...
<!-- <div class="signature-box"> -->
    ...
    <div id="signa-c"></div>
    <textarea id="signature-customer-64" name="sign-c" style="display: none;"></textarea>
    </br>
  ...
  <div class="gender-box">
    <h3>8. Pakej Unifi Terkini 2024</h3>
    </br>
    <div class="gender">
  ...
  <div class="input-box">
    ...
    <input type="text" class="box" placeholder="Pilih Tarikh & Waktu" autocomplete="off" name="tarikhWaktu" id="timedatePicker" required/>
  </div>

  <div class="input-box">
    <label>10. Bill Api / Bill Air (Bahagian Alamat)<span>*</span></label>
    <input type="file" name="imgBill" class="box" accept="image/jpg, image/jpeg, image/png, image/webp" required>
  </div>

  <div class="input-box">
    <label>11. Kad Pengenalan (Bahagian Depan)<span>*</span></label>
    <input type="file" name="imgKpD" class="box" accept="image/jpg, image/jpeg, image/png, image/webp" required>
  </div>

  <div class="input-box">
    <label>12. Kad Pengenalan (Bahagian Belakang)<span>*</span></label>
    <input type="file" name="imgKpB" class="box" accept="image/jpg, image/jpeg, image/png, image/webp" required>
  </div>
