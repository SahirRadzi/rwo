...
<head>
   ...
   <title>Update Status Demands Proceed | RWO Panel</title>
...
<section class="placed-orders">
   ...
   <h1 class="heading">update status proceed | <?= $jumlah_permintaanBaru_proses ;?></h1>
...
<div class="box-container">
   ...
   <?php
      ...
      echo '<p class="empty">no demands proceed yet!</p>';
   }
   ?>
   </div>
