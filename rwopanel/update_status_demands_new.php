...
<div class="box-container">  
   ...
   $select_listings = $conn->prepare("SELECT * FROM `demand_list` WHERE status = 'Baru' AND unique_id LIKE '%{$search_box}%' AND nokp LIKE '%{$search_box}%'");
   $select_listings->execute();
   }else

   $select_listings = $conn->prepare("SELECT * FROM `demand_list` WHERE status = 'Baru'");
   $select_listings->execute();
