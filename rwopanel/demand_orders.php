...
<head>
    ...
    <title>All Demands | RWO Panel</title>
...
<h1 class="heading">all demands</h1>
...
<div class="col-md">
    ...
    <div class="row-md">
       <a href="add_demands.php" class="btn btn-primary btn-lg">Add Demands</a>
...
<script src="../js/admin_table_demands_script.js"></script>
