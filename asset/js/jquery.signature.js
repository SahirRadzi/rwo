...
$(selector).signature({color: 'blue', guideline: true}) */
  ...
  console.log('Signature changed');
		...
		/** Global defaults for signature.
			...
			@example $.extend($.sbx.signature.options, {guideline: true}) */
	...
	/*$.widget('sbx.signature', $.ui.mouse, signatureOverrides);

	// Make some things more accessible
	$.sbx.signature.options = $.sbx.signature.prototype.options;*/
