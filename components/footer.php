...
<footer class="footer">
   ...
   <section class="flex">
      ...
      <div class="box">
         ...
         <a href="index.php#gallery"><span>gallery</span></a>
         <a href="index.php#coverage"><span>coverage</span></a>
      </div>
   ...
   <div class="credit"><span>RegisterWifi.Online</span> &copy; <?= date('Y'); ?> AIRRS VENTURE (003540822-X)</div>
