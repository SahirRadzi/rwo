      ...
      formatDate: function (e, t) {
        ...
        if (e instanceof Date) {
          for (r = t.length, a = 0; a < r; a++)
            "S" !== (i = t.charAt(a)) &&
              "\\" !== i &&
              (0 < a && "\\" === t.charAt(a - 1) ? (s += i) : ((o = this.parseFormat(i, e)), a !== r - 1 && this.intParts.test(i) && "S" === t.charAt(a + 1) && ((n = parseInt(o) || 0), (o += this.dateSettings.ordinal(n))), (s += o)));
          return s;
        }
        return "";
      },
          ...
          a = function (e) {
            ...
            return (
              "touchstart" === e.type || "touchmove" === e.type || "touchend" === e.type || "touchcancel" === e.type
                ...
                : ("mousedown" !== e.type && "mouseup" !== e.type && "mousemove" !== e.type && "mouseover" !== e.type && "mouseout" !== e.type && "mouseenter" !== e.type && "mouseleave" !== e.type) || ((a.x = e.clientX), (a.y = e.clientY)),
              a
            );
          },
          f = 0,
        ...
        (n = function (O) {
          ...
          function c(m) {
            ...
            m.mask && O.off("keydown.xdsoft"),
              !0 === m.mask &&
                (E.formatMask ? (m.mask = E.formatMask(m.format)) : (m.mask = m.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59"))),
              ...
              (I = L.extend(!0, {}, I, e)),
                ...
                e.highlightedPeriods &&
                  ...
                  L.each(e.highlightedPeriods, function (e, t) {
                    ...
                    for (; a <= n; )
                      (o = new m(a, r, d)), (i = E.formatDate(a, I.formatDate)), a.setDate(a.getDate() + 1), void 0 !== l[i] ? (s = l[i].desc) && s.length && o.desc && o.desc.length && (l[i].desc = s + "\n" + o.desc) : (l[i] = o);
                  }),
                  (I.highlightedDates = L.extend(!0, [], l))),
  ...
  (function (e) {
    ...
    function n(e) {
      ...
      if (
        ...
        return (
          (e.deltaX = o), (e.deltaY = i), (e.deltaFactor = h), (e.offsetX = s), (e.offsetY = d), (e.deltaMode = 0), n.unshift(e, r, o, i), m && clearTimeout(m), (m = setTimeout(D, 200)), (c.event.dispatch || c.event.handle).apply(this, n)
        );
      }
    }
    function D() {
